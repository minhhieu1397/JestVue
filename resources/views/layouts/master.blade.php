                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="./img/avatar.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <router-link to="/dashboard" class="nav-link router-link-exact-active router-link-active">
                        ...
                        <li class="nav-item">
                            <router-link to="/profile" class="nav-link router-link-exact-active router-link-active">
